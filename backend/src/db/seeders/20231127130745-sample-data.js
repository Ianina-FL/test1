...
const ContactsData = [
  {
    first_name: 'Murray Gell-Mann',

    last_name: 'Charles Sherrington',
...

  {
    ...
    last_name: 'Lynn Margulis',

    email: 'Gertrude Belle Elion',
