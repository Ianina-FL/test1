...
const ContactsData = [
  ...
  {
    first_name: 'Dmitri Mendeleev',

    last_name: 'Karl Landsteiner',

    email: 'Pierre Simon de Laplace',
...
const NotesData = [
  ...
  {
    content: 'Louis Victor de Broglie',
